  ...
  return (
    <DashboardShell>
      <section className="mb-6">
        <h2 className="text-xl font-semibold tracking-tight text-foreground">Decision Log</h2>
        <p className="mt-1 text-sm text-muted-foreground">
          Key decisions made across workstreams with owners and current status.
        </p>
      </section>

      <div className="mb-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
        <StatTile label="Total" value={decisionLogs.length} color="#475569" />
