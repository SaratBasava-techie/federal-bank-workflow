...
export const Route = createFileRoute("/landing")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Project Soulfire — Federal Bank Credit Card Portfolio Migration Executive Dashboard" },
    ],
  }),
  ...
  return (
    ...
    >
      ...
      {[180, 360, 540, 720].map((y, i) => (
        <line key={`h${i}`} x1="0" y1={y} x2="1440" y2={y} stroke="#003087" strokeWidth="0.5" strokeOpacity="0.4" />
      ))}
    </svg>
  );
}
    ...
    <div style={{
          ...
          if (p.type === "line-h") {
            return (
              <div key={p.id} style={{
                position: "absolute",
                left: `${p.x}%`, top: `${p.y}%`,
                width: p.size * 12, height: 1,
                background: "linear-gradient(90deg, transparent, rgba(0,153,168,0.5), transparent)",
                opacity: baseOpacity,
                transform: "translate(-50%,-50%)",
              }} />
            );
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 600, letterSpacing: "0.12em", color: "rgba(255,255,255,0.5)", textTransform: "uppercase" }}>
            Federal Bank
          </span>
        </div>
        ...
        <div style={{
          ...
          <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.15em", color: "rgba(245,158,11,0.85)", textTransform: "uppercase" }}>
            Confidential
          </span>
        </div>
      </nav>
      ...
      <main style={{
        ...
        >
          ...
          <div style={{
            ...
            justifyContent: "center",
            borderRadius: "50%",
            background: "radial-gradient(circle at 40% 35%, rgba(0,48,135,0.6) 0%, rgba(0,7,26,0.95) 100%)",
        ...
        <div style={{
          ...
          <div style={{ width: 40, height: 1, background: "linear-gradient(90deg, transparent, rgba(0,153,168,0.7))" }} />
          <span style={{
          ...
          <div style={{ width: 40, height: 1, background: "linear-gradient(90deg, rgba(0,153,168,0.7), transparent)" }} />
        </div>
      ...
      <footer style={{
        ...
        <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.2em", color: "rgba(255,255,255,0.28)", textTransform: "uppercase" }}>
          Confidential&nbsp;&nbsp;·&nbsp;&nbsp;July 2026
        </span>
        <span style={{ fontSize: 10, fontWeight: 500, letterSpacing: "0.1em", color: "rgba(255,255,255,0.22)" }}>
