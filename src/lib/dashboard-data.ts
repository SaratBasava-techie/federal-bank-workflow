...
export const pendingFromTsys: PendingItem[] = [
  ...
  },
  {
    ...
    activity:
      "Received payload details for 60 SMS & emails on 9 Jul. Pending details for 30 SMS and Email payloads.",
    leads: "Vipin",
  ...
  },
  {
    ...
    activity:
      "Security testing report for firewall approval at FB. FB needs to re do the work if it didn't gets resolved by 13th July",
    leads: "Ananya",
    dateRaised: "3/7/2026",
  },
];
