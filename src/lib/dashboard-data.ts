...
export const pendingFromTsys: PendingItem[] = [
  ...
  },
  {
    ...
    activity: "Development to be initiated by 13th July and to be completed by 31st July, sessions going on with delay",
    leads: "Vipin/Petros",
  ...
  },
  {
    ...
    activity: "TSYS to start development with changes shared by FB, timeline awaited",
    leads: "Mahendra & Sameer",
    dateRaised: "3/7/2026",
  },
  {
    sn: 4,
    workstream: "KAFKA SMS and Email payload related",
    activity: "Alert mapping document to be shared by TSYS to FB",
    leads: "Vipin",
  ...
  },
  {
    ...
    activity: "Security testing report for firewall approval at FB. Issue in the access at FB's end",
    leads: "Ananya",
    dateRaised: "3/7/2026",
  },
];
...
export const riskLogs: RiskLog[] = [
  ...
  },
  {
    ...
    workstream: "IT",
    detail:
      "A CIF unique identifer aligned with the existing TSYS reference number should be defined and confirmed by SCB.",
    mitigation: "",
    raised: "7-Jun-2026",
    level: "High",
    status: "Open",
...
export const decisionLogs: DecisionLog[] = [
  {
    ...
    area: "Card features",
    details:
      "A key decision has been made to replicate all existing Soulfire card configurations, features, and pricing structures in the Federal environment without any modifications.",
    owner: "Libu",
    status: "Closed",
  ...
  },
  {
    ...
    area: "Card Fee",
    details:
      "Annual fee services will be migrated and maintained under Federal Bank, with fees charged based on original migrated services and existing card charge dates (not re-carding dates).",
    owner: "Libu",
    status: "Closed",
  ...
  },
  {
    ...
    area: "Card Account",
    details:
      "All customer accounts, including active and closed, will be migrated from Standard Chartered Bank to the Federal Bank portfolio. The migration scope will include all cards, irrespective of status (active, inactive, closed, expired, or replaced).",
    owner: "Libu",
    status: "Closed",
    remarks: "Data migration scope document to be considered as evidence",
  },
  {
    ...
    area: "Scope",
    details:
      "The scope of data migration and its subsequent attributes will be discussed and agreed  between all three parties (FB, SCB, TSYS)",
    owner: "Joint",
    status: "WIP",
    remarks: "",
  },
  ...
  },
  {
    ...
    area: "Rewards",
    details:
      "A decision has been made that all LR rewards accrual and redemption activities will be processed within the LR system. TSYS will continue to implement and maintain the required business logic updates within its platform and ensure seamless routing of all relevant transactions to LR.",
    owner: "Libu",
    status: "Closed",
    remarks: "Data migration scope document to be considered as evidence",
  },
  ...
  },
  {
    ...
    area: "Product",
    details:
      "A Joint decision between SCB and FB, needs to be made on usage of Manhattan card name post portfolio transfer.",
    owner: "Leadership (FB, SCB)",
    status: "Closed",
    remarks:
      "Evidence considered as product code mapping confirmation to TSYS, where mentioned VISA Manhattan Platinum card mapping to FB Manhattan Platinum Primary card.",
  },
  {
    sn: 12,
    workstream: "Business",
    area: "Recarding",
    details:
      "The decision on 37 day timeline for card closure is agreed to commence from the BIG Bang date.",
    owner: "Saugata",
    status: "Closed",
  ...
  },
  {
    ...
    details:
      "As a Authentication Protocol the Email Authentication, as MFA method will be enabled for integration/configurations.",
    owner: "Dinu",
    status: "Closed",
  ...
  },
  {
    ...
    details:
      "FB to work on BPO set up/dispute management for aquired portfolio. To elaborate the TSYS BPO setup is based out of the Philippines, while the data storage is maintained in India. Require the decision makking on the operating model with compliance & regulatory perspective in India",
  ...
  },
  {
    ...
    details:
      "IT to take-up CISO exception approval for Production enviroment creation and data migration enviroment creation",
    owner: "Sreejith",
    status: "Closed",
  ...
  },
  {
    ...
    area: "Embossing File",
    details:
      "FIS has confirmed that the embossing file can be generated in a single-line format, in alignment with the specifications and expectations of the embossing team, eliminating the need for the earlier two-line format.",
    owner: "TSYS",
    status: "Closed",
  ...
  },
  {
    ...
    area: "Statement",
    details:
      "Decision on revision of the past 12 month's statement format in line with the Federal template, with finalization and approval from SCB, considering that existing statements contain card details and branding elements.",
    owner: "Libu",
    status: "WIP",
    remarks: "",
  },
