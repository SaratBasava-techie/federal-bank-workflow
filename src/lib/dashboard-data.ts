...
export const ragSummary: RagItem[] = [
  {
    sn: 1,
    workstream: "Business",
    activity: "BAR Forms closure with scheme & TSYS",
    owner: "FB",
    leads: "Dinu / Sreejith",
  ...
  },
  {
    ...
    activity: "Key channel services validation (Web, Batch files, Kafka) completion",
    owner: "FB, TSYS",
    leads: "Dinesh, Dinu, Anupam",
    dateRaised: "20-06-2026",
    targetDate: "30-06-2026",
    rag: "warning",
  },
  {
    sn: 5,
    workstream: "Channel Connectivity",
    activity: "WhatsApp banking integration with TSYS & IVR requirement from business to be shared to digital channel and IVR team",
    owner: "FB",
    leads: "Bhagyashree / Srejith",
